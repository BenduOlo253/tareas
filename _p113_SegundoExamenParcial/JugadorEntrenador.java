...
public class JugadorEntrenador extends Jugador {
    ...
    public String toString(){
        return String.format("- JugadorEntrenador %s Subordinados= %d, Proyectos= %d, Bono= %.2f, Total= %.2f]", super.toString(), Subordinados, Proyectos, getBono(), (this.getSalario() + this.getBono()));
    }
}
