//Alumno: Jose Manuel Rberto Badillo.
//Descripción: Crear un programa que inicialize de forma manual arreglo de números flotantes y al terminar que lo imprima.

public class _p81_InicializaArregloNumeros {
    public static void main(String[] args) {
        //Inicializamos el arreglo tipo double.
        double[] nums = new double[7];

        //Asignamos valores a los lugraes del arreglo.
        nums[0] = 5.0;
        nums[1] = 10.0;
        nums[2] = 15.5;
        nums[3] = 20.5;
